...
public class ClassicCar_login {
	...
	public static String email = "jilanimd23@gmail.com";
	public static String pass = "bikroyjilani21";
	...
	public static void loginAccount() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//button[@class='btn--1gFez secondary--Os-e9 background--2lR9B small--1MQ15 gtm-email-login']")).submit();
		...
		driver.findElement(By.xpath("//div[@class='col-6 lg-3']//span[@class='ui-sprite categories-36 mobiles']")).click();
		...
		driver.findElement(By.xpath("//button[@class='btn--1gFez secondary--Os-e9 background--2lR9B small--1MQ15 search-button--1RZdg background--2lR9B gtm-pwa-search']")).click();
		//Thread.sleep(1000);
		...
		//Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@class='display--s3dc8 card--_2NNk']//div[@class='chat-text--NpECZ'][contains(text(),'Chat')]")).click();
		//Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='input_1']")).sendKeys(message);
		//Thread.sleep(1000);
		//driver.findElement(By.xpath("//button[@class='send-button--O40Hd gtm-chat-send']")).click();
